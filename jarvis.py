...
# Before you begin make sure to install all the packages and modules
import pyttsx3
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('here your email', 'here your password')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            codePath = "C:\\Users\\Shifa\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            ...
            try:
                ...
                content = takeCommand()
                to = "Email of the person you want to send an email"
